...
class EventForm extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(event) {
    super();
  ...
  _applyFlatpickr() {
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_2___default()(startDateElement, {
      altInput: true,
      allowInput: true,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripEventController; });
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
...
class TripEventController {
  ...
  render(event) {
    ...
    this._tripEventComponent = new _components_trip_event_js__WEBPACK_IMPORTED_MODULE_1__["default"](event);
    this._eventFormComponent = new _components_event_form_js__WEBPACK_IMPORTED_MODULE_2__["default"](event);
    ...
    if (oldTripEventComponent && oldEventFormComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._tripEventComponent, oldTripEventComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._eventFormComponent, oldEventFormComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._tripEventComponent, `beforeend`);
    }
  }
  ...
  _replaceEditToEvent() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._tripEventComponent, this._eventFormComponent);
    this._mode = Mode.DEFAULT;
  }

  _replaceEventToEdit() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._eventFormComponent, this._tripEventComponent);
...
/* harmony import */ var _trip_event_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./trip-event.js */ "./src/controllers/trip-event.js");
...
const sortedEventsKey = _components_trip_events_list_js__WEBPACK_IMPORTED_MODULE_5__["SORTED_ARRRAY_KEY"];
...
const getSortedEvents = (events, sortType) => {
  ...
  switch (sortType) {
    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_4__["SortType"].EVENT:
      sortedEvents = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getEventsPerDay"])(events);
      break;
    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_4__["SortType"].TIME:
      sortedEvents.sorted = eventsToSort
      .sort((a, b) => getDuration(b.startDate, b.endDate) - getDuration(a.startDate, a.endDate));
      break;
    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_4__["SortType"].PRICE:
...
class TripController {
  ...
  _renderEvents(events, onDataChange, onViewChange) {
    ...
    const renderEvent = (event, container) => {
      const tripEventController = new _trip_event_js__WEBPACK_IMPORTED_MODULE_6__["default"](container, onDataChange, onViewChange);
    ...
    this._tripEventsListComponent = new _components_trip_events_list_js__WEBPACK_IMPORTED_MODULE_5__["default"](this._structuredEvents);
  ...
  _updateEvents(events) {
    this._events = events;
    this._structuredEvents = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getEventsPerDay"])(this._events);
  }
